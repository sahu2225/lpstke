...
import { Table, Tooltip, Avatar, Form, Switch, Input, Select, Button } from 'antd';
import { QuestionCircleOutlined, UnorderedListOutlined, InsertRowBelowOutlined, ClockCircleOutlined } from '@ant-design/icons';
...
const Pools = ({ conectmetaMask, accountDottedAddress }) => {
    ...
    const columns = [
      {
        // title: 'Hope-BNB',
          dataIndex: 'name',
          key: 'name',
          render: () => <div className='name-img'>
            <Avatar.Group>
          <Avatar src="https://joeschmoe.io/api/v1/random" />
          <Avatar style={{ backgroundColor: '#f56a00' }}>K</Avatar>
        </Avatar.Group>
        <p style={{lineHeight: '100%'}}>GDCC<br></br>
          <span style={{display: 'inline-block', width: '100%', fontSize: '12px', color: '#858484'}}>Stake, Earn – And more!</span>
        </p>
          </div>,
      },
      {
        ...
        dataIndex: '',
        key: 'x',
        render: () => <div className='core-icon'>
                          <p><svg viewBox="0 0 24 24" width="18px" color="secondary" xmlns="http://www.w3.org/2000/svg" className="sc-eaf7e66-0 dodMCi"><path d="M23 12L20.56 9.21L20.9 5.52L17.29 4.7L15.4 1.5L12 2.96L8.6 1.5L6.71 4.69L3.1 5.5L3.44 9.2L1 12L3.44 14.79L3.1 18.49L6.71 19.31L8.6 22.5L12 21.03L15.4 22.49L17.29 19.3L20.9 18.48L20.56 14.79L23 12ZM9.38 16.01L7 13.61C6.61 13.22 6.61 12.59 7 12.2L7.07 12.13C7.46 11.74 8.1 11.74 8.49 12.13L10.1 13.75L15.25 8.59C15.64 8.2 16.28 8.2 16.67 8.59L16.74 8.66C17.13 9.05 17.13 9.68 16.74 10.07L10.82 16.01C10.41 16.4 9.78 16.4 9.38 16.01Z"></path></svg></p> 
                          <span>Core</span>
                      </div>,
    },
    ...
    },
    {
        ...
        dataIndex: 'liquidity',
        key: 'address',
        render: () => <div className='liquidity'>
                        <p>Total staked</p>
                          <span>$119,022,665
                            &nbsp;
                            <ClockCircleOutlined />
          ...
          <div className="row align-items-center">
            ...
            <div className='row'>
              <div className='col-md-4'>
                <Link to='/grid-pools' style={{marginRight: '12px', fontSize: '18px'}}><InsertRowBelowOutlined /></Link>
                <Link to='/pools' style={{fontSize: '18px'}}><UnorderedListOutlined /></Link>
              </div>
                          ...
                          <div className="col-md-4">
                            <div className='links'>
                              ...
                              <div className="ljmSfA">
                                <svg viewBox="0 0 24 24" width="18px" color="success" xmlns="http://www.w3.org/2000/svg" className="fHPuPF"><path d="M12 6V7.79C12 8.24 12.54 8.46 12.85 8.14L15.64 5.35C15.84 5.15 15.84 4.84 15.64 4.64L12.85 1.85C12.54 1.54 12 1.76 12 2.21V4C7.58 4 4 7.58 4 12C4 13.04 4.2 14.04 4.57 14.95C4.84 15.62 5.7 15.8 6.21 15.29C6.48 15.02 6.59 14.61 6.44 14.25C6.15 13.56 6 12.79 6 12C6 8.69 8.69 6 12 6ZM17.79 8.71C17.52 8.98 17.41 9.4 17.56 9.75C17.84 10.45 18 11.21 18 12C18 15.31 15.31 18 12 18V16.21C12 15.76 11.46 15.54 11.15 15.86L8.36 18.65C8.16 18.85 8.16 19.16 8.36 19.36L11.15 22.15C11.46 22.46 12 22.24 12 21.8V20C16.42 20 20 16.42 20 12C20 10.96 19.8 9.96 19.43 9.05C19.16 8.38 18.3 8.2 17.79 8.71Z"></path></svg>
                                Auto &nbsp; 
                          ...
                          <div className="col-md-4">
                            <div className='Hope-earn jbGbNT'>
                              ...
                              <div className='content jJGrtW'>
                                ...
                                <button className="panHope-btn izhINH pancake-button--disabled" disabled="">Harvest</button>
                              </div>
                            </div>
                          </div>
                          <div className="col-md-4">
                            <div className='start-farming'>
                              ...
                              <div className='content'>
                                ...
                                <ConnectWallet buttonClass={'bjAFXE'} conectmetaMask={conectmetaMask} accountDottedAddress={accountDottedAddress}/>
                                :
                              <TokenPopup />
                              }
                              </div>
