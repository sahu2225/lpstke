...
import { ReactComponent as HopiumLogo } from '../../Hopium.svg';
...
const Header = ({ conectmetaMask, accountDottedAddress }) => {
          ...
          <div className='collapse navbar-collapse' id='navbarSupportedContent'>
            <ul className='navbar-nav me-auto mb-2 mb-lg-0'>
              <li className='nav-item'>
                <Link className='nav-link active nav-font' to='/farms'>
                  Farms
                </Link>
              </li>
              <li className='nav-item'>
                <Link className='nav-link nav-font' to='/pools'>
                  Pools
                </Link>
              </li>
            </ul>
            <div className='d-flex'>
              <ul className='navbar-nav me-auto mb-2 mb-lg-0'>
                {/* <li className='nav-item'>
                  <Link
                    className='nav-link active hBzETS'
                    target='_blank'
                    to='/farms'
                  >
                    <svg
                    ...
                    <div className='gROoTx'>$3.362</div>
                  </Link>
                </li> */}
                ...
                <li className='nav-item'>
                  {/* <Link className="nav-link btn-connect-wallet" to="/" onClick={() => setShowWallet(true)}>Connect Wallet</Link> */}

                  {/* <ConnectWallet show={showWallet} close={() => setShowWallet(false)} /> */}
                  <ConnectWallet
                    buttonClass={'btn-connect-wallet'}
